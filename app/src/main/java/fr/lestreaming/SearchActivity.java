...
import fr.lestreaming.adapters.LiveTvAdapter2;
import fr.lestreaming.adapters.SearchAdapter;
import fr.lestreaming.network.RetrofitClient;
import fr.lestreaming.network.apis.SearchApi;
import fr.lestreaming.network.model.CommonModel;
import fr.lestreaming.network.model.SearchModel;
import fr.lestreaming.network.model.TvModel;
import fr.lestreaming.utils.ApiResources;
import fr.lestreaming.utils.SpacingItemDecoration;
...
import static fr.lestreaming.utils.MyAppClass.getContext;
...
//        }
        ...
        searchQueryTv.setText(getString(R.string.search_show) +query );
        ...
        movieRv.addItemDecoration(new SpacingItemDecoration(2, Tools.dpToPx(this, 12), true));
        ...
        call.enqueue(new Callback<SearchModel>() {
            ...
            public void onResponse(Call<SearchModel> call, retrofit2.Response<SearchModel> response) {
                ...
                if (response.code() == 200) {
                    ...
                    new ToastMsg(SearchActivity.this).toastIconError(getString(R.string.error_toast));
                    coordinatorLayout.setVisibility(View.VISIBLE);
                }
